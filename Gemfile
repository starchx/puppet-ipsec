...
# Add some auxiliary gems
gems['puppet-strings']             = ['~> 1.0', require: false]
gems['puppet-blacksmith']          = [require: false]
gems['github_changelog_generator'] = [require: false]
gems['semantic_puppet']            = [require: false]
