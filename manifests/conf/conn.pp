...
define ipsec::conf::conn(
  ...
  concat::fragment{ "conn ${name}":
    target  => lookup('ipsec::config::conf_file'),
    order   => 3,
    content => epp('ipsec/conf_conn.epp', {
      'name'            => $title,
      'aaa_identity'    => $aaa_identity,
      'ah'              => $ah,
      ...
      'lifebytes'       => $lifebytes,
      'lifepackets'     => $lifepackets,
      'lifetime'        => $lifetime,
      'marginbytes'     => $marginbytes,
      'marginpackets'   => $marginpackets,
      ...
      'type'            => $type,
      'xauth'           => $xauth,
      'xauth_identity'  => $xauth_identity,
      'left'            => $left,
      'right'           => $right,
      'leftallowany'    => $leftallowany,
      'rightallowany'   => $rightallowany,
      'leftauth'        => $leftauth,
      'rightauth'       => $rightauth,
      'leftauth2'       => $leftauth2,
      'rightauth2'      => $rightauth2,
      'leftca'          => $leftca,
      'rightca'         => $rightca,
      'leftca2'         => $leftca2,
      'rightca2'        => $rightca2,
      ...
      'rightcert'       => $rightcert,
      'leftcert2'       => $leftcert2,
      'rightcert2'      => $rightcert2,
      'leftcertpolicy'  => $leftcertpolicy,
      'rightcertpolicy' => $rightcertpolicy,
      'leftdns'         => $leftdns,
      'rightdns'        => $rightdns,
      ...
      'leftgroups2'     => $leftgroups2,
      'rightgroups2'    => $rightgroups2,
      'lefthostaccess'  => $lefthostaccess,
      'righthostaccess' => $righthostaccess,
      'leftid'          => $leftid,
      'rightid'         => $rightid,
      'leftid2'         => $leftid2,
      'rightid2'        => $rightid2,
      'leftikeport'     => $leftikeport,
      'rightikeport'    => $rightikeport,
      'leftprotoport'   => $leftprotoport,
      'rightprotoport'  => $rightprotoport,
      'leftrsasigkey'   => $leftrsasigkey,
      'rightrsasigkey'  => $rightrsasigkey,
      'leftsigkey'      => $leftsigkey,
      'rightsigkey'     => $rightsigkey,
